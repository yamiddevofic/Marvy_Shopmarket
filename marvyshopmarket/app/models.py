...
class Productos(db.Model):
    ...
    tienda_Id = db.Column(db.Integer,db.ForeignKey('tenderos.tienda_Id'))
...
class SuministrosProveedores(db.Model):
    ...
    tienda_Id = db.Column(db.Integer,db.ForeignKey('suministros.tienda_Id'))
    prov_Id = db.Column(db.Integer,db.ForeignKey('proveedores.prov_Id'))
...
class Ventas(db.Model):
    ...
    tendero_Id =db.Column(db.Integer, ForeignKey('tenderos.tendero_Id'))
    tienda_Id =db.Column(db.Integer, ForeignKey('tiendas.tienda_Id'))
