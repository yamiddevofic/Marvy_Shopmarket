...
const Home = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-200">
      <Header
        userName={userName}
        adminInfo={adminInfo}
      />
      ...
      <main className="container mx-auto px-4 py-6 lg:px-8">
        <ProfileSection 
          ...
          adminInfo={adminInfo}
          error={error}
          imageUrl={imageUrl} // Pasar la URL de la imagen al componente
        />
        ...
        <div className="mt-8 bg-emerald-50 dark:bg-gray-700/50 rounded-2xl p-6">
